  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="<?=dirname($_SERVER['SCRIPT_NAME'])?>/articles">Articles <span class="sr-only">(current)</span></a> <!-- Ссылки, на документы, которые пишутся, с помощью dirname -->
      </li>
      <li class="nav-item">
